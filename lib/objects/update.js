var util = require('util'),
  ...
  proto = {
    ...
    update: function (text, options) {
      ...
      if (options) {
        _.assign(data, _.pick(options, ['now', 'media', 'utc', 'scheduled_at']))
      }
    ...
    interactions: function (event, options) {
      ...
      if (options) {
        _.assign(data, _.pick(options, ['count', 'page']))
      }

      return this.api.post(util.format(endpoints.interactions, this.id), {authorize: true, form: data})
    }
  }
